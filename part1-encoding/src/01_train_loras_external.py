# part1-encoding/src/01_train_loras_external.py

# This script trains LoRA weights on a pretrained Stable Diffusion XL model to encode specific concepts into the weights. 
# It is taken from our reference paper Concept Sliders and we trained the LoRA sliders with the config/train-sliders/ specs, which match the paper's requirements.
# For the sake of brevity, we do not include the full repo, just the main script used in training by the authors.
